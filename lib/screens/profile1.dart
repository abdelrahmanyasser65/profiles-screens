            ...
            padding:const EdgeInsets.only(
              ...
              child: Row(
                children: [
                  ...
                  InkWell(
                      onTap: (){},
                      child:const Icon(Icons.more_vert,color: Colors.black,size: 25,))
                ],
              )),
          const  SizedBox(height: 15,),
          Container(
            padding:const EdgeInsets.only(
              left: 54,top: 3,right: 21
            ),
            height: 380,
            child: SizedBox(
              ...
              child: Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children:const [
                      Text("Started following Tony Mendez",style:
                  ...
                  const Image(image: AssetImage('images/Oval 3.png'),)
                ],
              ),
            ),
          ),
