                   ...
                   children: [
                     Row(
                       children:const [
                         Spacer(),
                         Text("01",style:
                           TextStyle(fontSize: 18,fontWeight: FontWeight.bold,fontStyle: FontStyle.italic),)
                       ],
                     ),
                     ...
                     Row(
                       ...
                       children: [
                         ...
                         Column(
                           crossAxisAlignment: CrossAxisAlignment.start,
                           children:const [
                             Text("Stephen Mack",style:
                               TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                             SizedBox(height: 7,),
                             Text("San Francisco, CA",style:
        ...
        children: [
          ...
          Container(
           ...
           width: 200,
            ...
            child:const Text("02/05/2018",style:
            TextStyle(fontSize:12,fontWeight: FontWeight.w300),),
          ),
        ],
      ),
